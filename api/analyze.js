...
function buildPrompt(article) {
  return [
    ...
    '2. 다음 항목은 [기사 정보]에 문자 그대로 등장하지 않는 한 절대 만들어내지 마세요:',
    '   - 구체적 수치·통계·비율·금액',
    '   - 날짜·일정·기한 (예: "지난 15일", "다음 달부터" 등 구체적 시점)',
    '   - 합의·발표·결정 내용의 세부사항 (누가 무엇에 합의했는지, 정확히 무엇이 결정됐는지)',
    '   - 특정 인물·기관의 발언이나 인용문',
    '   - [기사 정보]에 이름이 나오지 않은 특정 기업/기관을 콕 집어 "수혜를 본다/영향받는다"는 식으로 단정하는 것',
    '   일반적인 경제 상식(예: "기준금리 인상은 대출 이자 부담을 늘린다")은 배경 설명으로 써도 되지만, 이 기사에서만 확인 가능한',
    '   구체적 사실인 것처럼 서술하면 안 됩니다.',
    '3. 위 금지 항목에 해당하는 내용을 써야 하는 상황이라면, 그 문장 대신 정확히 다음 두 문구 중 하나를 사용하세요',
    '   (문구를 변형하지 말고 그대로 쓰세요): "제공된 기사 정보만으로는 확인하기 어렵습니다." 또는 "추가 정보가 필요합니다."',
    '   7개 항목 전체가 아니라, 확인 불가능한 부분에 한해서만 이 문구를 쓰고 나머지는 정상적으로 작성하세요.',
    '4. 각 항목은 2~4문장의 한국어로, 경제 지식이 많지 않은 독자도 이해할 수 있게 쉬운 문장으로 쓰세요.',
    '5. 작성을 마친 뒤, 각 문장이 [기사 정보]에 실제로 있는 내용인지 스스로 다시 확인하고, 근거 없이 지어낸 구체적 사실이',
    '   남아 있다면 규칙 3의 문구로 바꾸세요.',
    '',
    '다음 7개 항목을 각각 작성하세요:',
